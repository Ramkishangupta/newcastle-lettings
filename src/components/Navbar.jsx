            ...
            {dropdown && openDropdown === name && (
              ...
              >
                <ul className="space-y-4">
                  {dropdown.map((item, i) => (
                    <li key={i} className="font-light tracking-wide text-base hover:text-[#233366] cursor-pointer">
                      {item}
                    </li>
                  ))}
                </ul>
      ...
      {mobileOpen && (
        ...
        >
          ...
          <div className="flex justify-between border-t border-[#2e4170] text-white text-sm">
            <div className="flex items-center gap-2 px-4 py-3"><FaEnvelope /> enquiries@sw.co.uk</div>
            <div className="flex items-center gap-2 px-4 py-3"><FaPhone /> 0800 122 3050</div>
          </div>
